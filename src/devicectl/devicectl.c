...
static const struct action {
	...
	{ DEVICE_EXTCON,    "enable",          4, enable_device,     "[USB|HEADPHONE|HDMI|DOCK|earkey|hdcp|ch_hdmi_audio|keyboard]" },
	{ DEVICE_EXTCON,    "disable",         4, disable_device,    "[USB|HEADPHONE|HDMI|DOCK|earkey|hdcp|ch_hdmi_audio|keyboard]" },
};
