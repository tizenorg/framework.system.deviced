...
static int battery_critical_low_act(void *data)
{
	...
	device_notify(DEVICE_NOTIFIER_BATTERY_CRITICAL_POPUP,
	    (void *)cur_bat_capacity);
	return 0;
}
