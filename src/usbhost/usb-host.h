...
#define MSG_CONNECTOR_CONNECTED         "USBConnectorConnected"
#define MSG_CONNECTOR_DISCONNECTED      "USBConnectorDisconnected"
#define MSG_STORAGE_CONNECTED           "StorageConnected"
#define MSG_STORAGE_RO_CONNECTED        "StorageConnectedRO"
#define MSG_STORAGE_DISCONNECTED_SAFE   "StorageDisconnectedSafe"
#define MSG_STORAGE_DISCONNECTED_UNSAFE "StorageDisconnectedUnsafe"
#define MSG_KEYBOARD_CONNECTED          "KeyboardConnected"
#define MSG_MOUSE_CONNECTED             "MouseConnected"
#define MSG_CAMERA_CONNECTED            "CameraConnected"
#define MSG_PRINTER_CONNECTED           "PrinterConnected"
#define MSG_DEVICE_DISCONNECTED         "DeviceDisconnected"
...
void send_msg_usbhost_connected(void);
void send_msg_usbhost_disconnected(void);
